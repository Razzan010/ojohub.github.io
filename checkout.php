...
<div class="mg-l-16 p-relative tran-02s home-search-wrap only-in-desk-md" style="padding-top: 10px; color: white; font-weight: bold; text-align: center;">
		<h4 style="color: Grey; font-weight: bold;">Step 1</h4>
...
<div class="col-md-12" style="text-align: center; ">
	<h3 style="color: black;">How do you want to receive it ?</h3>
...
<?php 
echo "<a href='delivery_paymentoptions.php?product_id=$product_id '>
  <button class='btn btn-primary' style=''>Home Delivery</button>
  </a>"
  ?>
    <br>

<?php 
echo "<a href='pickup_paymentoptions.php?product_id=$product_id '>
  <button class='btn btn-primary' style='margin-top:15px;'>Pickup from Store</button>  
  </a>"

  ?>
  <p style='color:grey;'>You may save Delivery charge(s).</p>
