...
<?php 
echo "<a href='eSewa_checkout.php?product_id=$product_id '>
...
<?php 
echo "<a href='pay_on_delivery.php?product_id=$product_id '>
  <button class='btn btn-primary' style='margin-top:15px;'>Pay on Delivery</button>
  </a>"
  ?>
