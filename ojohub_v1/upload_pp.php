...
<form action="upload_pp.php" method="post" enctype="multipart/form-data">
	...
	<div class="col-md-4">
	<h3 style="text-align: center;font-weight: bold; padding-top: 10%;padding-bottom: 5%;">Upload Profile Picture</h3>
	...
	<button  class="login-btn-login-page" name="submit" style="margin-left: 40%;color: white;font-weight: bold;">
			Upload               
	</button>
		</div>	
...
if (isset($_POST['submit'])) {      
		...
		move_uploaded_file($image1_tmp, "owner_images/$image1");		 
		    
		    $insert_customer="UPDATE stores set owner_image='$image1' where customer_email='$customer_email'";
