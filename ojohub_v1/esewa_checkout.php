...
<div class="col-md-12" style="text-align: center; ">
	<h3>Pay with esewa (Home Delivery)</h3>
      ...
      <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input type="text" name="reg_email" class="form-control" required="" value="<?php echo $customer_email;  ?>" disabled >  
               ...
               <button class="btn btn-primary" style="margin-top: 20px;background-color: green;" name="confirm">Confirm</button>           
            </div>
...
<h2 style='font-weight: bold;color: green; text-align:center;width:100%; background-color:lightgreen'><a href='http://localhost/index.php'> Ojohub.com <a/> </h2> 

   	👋 Hallo $customer_name,
		<br>
	We would like to inform you that, we have received your order. Please complete your order by transfering the required amount with Transaction Code as Remarks. We will delivery you order, when the payment is confirmed.
...
<p style='color:blue;font-weight:bold;'>You received this Email as you choose payment option as esewa Transfer. Here is the account details for your payment:</p>
...
<div style='margin-left:5%;'>
	...
	Remarks:
	<br>
	Important: Don't forget to put Transaction Code as Remarks.
</div>	
