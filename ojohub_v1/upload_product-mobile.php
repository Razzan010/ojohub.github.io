...
$webos = strpos($_SERVER['HTTP_USER_AGENT'],"webOS");
    if ($android || $bberry || $iphone || $ipod || $webos== true) { 
        ...
        header('Location: http://www.store.ojohub.com/Uploading-Product');        
    }
?>
...
<form action="Uploading-Product-m" method="post" class="form-group" enctype="multipart/form-data">
<?php
...
<div class="form-group " style="width:100%;">
    <a href="Selecting-Category-m">
    	...
    	<div class="" style="color:black;">
    	    Category :
    	    <input style="border: 2px solid red ;color:orange;font-weight:bold;" value="<?php echo $category?>" type="text" name="category" class="form-control" style="font-weight: bold;" required="" >
    	</div>
        
        <div class="" style="color:black;">
            Sub-category :
            <input style="border: 2px solid red ;color:orange;font-weight:bold;" value="<?php echo $sub_category?>" type="text" name="category" class="form-control" style="font-weight: bold;" required="" >
        </div>
...
<div class="form-group">
	...
	<input style="border: 2px solid red ;" type="text" name="product_title" class="form-control" style="font-weight: bold;" required="" >
</div>
...
<div class="col-md-12 form-group">					
	...
	Rs:
    	...
    	<input style="border: 2px solid red ;margin-top:5px;" type="number" name="product_price" id="num1" class="form-control" style="width: 30%;" required="" >
...
<div>
	...
	<label>Product Description</label>
        <textarea name="product_desc" class="form-control" style="width: 100%; height: 15%;   border: 2px solid red ;resize: none;" required></textarea> 
...
<br>
	...
	<P style="border: 1px solid; color: red;">Required
...
<div class="form-group">
	...
	<input style="border: 2px solid red ;" autocomplete="off" type="text" name="product_dist_new" class="form-control" required="" value="" >			
</div>
...
<div class="form-group">
	<label>
	<i class='fa fa-dot-circle-o'></i>
	Can be deliver to the Buyers address?
