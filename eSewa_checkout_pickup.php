...
<div class="mg-l-16 p-relative tran-02s home-search-wrap only-in-desk-md" style="padding-top: 10px; color: white; font-weight: bold; text-align: center;">
		<h4 style="color: white; font-weight: bold;">Checkout with Esewa</h4>
...
<form action="" method="post" style="text-align: left;">
    ...
    <h4 style="color: green;font-weight: bold;padding-top: 10px;">Contact Details</h4>
...
<div style='margin-left:5%;'>
	...
	Remarks:
	<br>
	Important: Don't forget to put Transaction as Remarks.
</div>	
